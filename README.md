...
1. What is the purpose of using _sessions_?
    ...
    Sessions are commonly used to allow a server to store and retreive information about their clients.

1. What does bcrypt do to help us store passwords in a secure manner.

    Bcrypt hashes plane passwords so we never store them in our database. 
